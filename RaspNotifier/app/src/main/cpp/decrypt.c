//
// Created by prashant-admin on 2/1/18.
//
...
#define DHTPIN		7
char DEVICE_ID[33] = "214db0574856c6d17ce36328159dd045";
...
int main()
{
	...
	if((25 - dht11_dat[0] >= 5) || (25 - dht11_dat[0] <= -5))
	{
		encrypt();
...
{
	srand(time(0));
	char randomString[100] = "abcdef1234567890";
	int i;
