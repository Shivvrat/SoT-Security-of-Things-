...
public class CkSocket {
  ...
  public boolean get_HttpProxyForHttp() {
    return chilkatJNI.CkSocket_get_HttpProxyForHttp(swigCPtr, this);
  }

  public void put_HttpProxyForHttp(boolean newVal) {
    chilkatJNI.CkSocket_put_HttpProxyForHttp(swigCPtr, this, newVal);
  }
  ...
  public int get_ListenPort() {
    return chilkatJNI.CkSocket_get_ListenPort(swigCPtr, this);
  }
  ...
  public int BindAndListenPortRange(int beginPort, int endPort, int backLog) {
    return chilkatJNI.CkSocket_BindAndListenPortRange(swigCPtr, this, beginPort, endPort, backLog);
  }

  public CkTask BindAndListenPortRangeAsync(int beginPort, int endPort, int backLog) {
    long cPtr = chilkatJNI.CkSocket_BindAndListenPortRangeAsync(swigCPtr, this, beginPort, endPort, backLog);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask PollDataAvailableAsync() {
    long cPtr = chilkatJNI.CkSocket_PollDataAvailableAsync(swigCPtr, this);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean ReceiveBd(CkBinData binData) {
    return chilkatJNI.CkSocket_ReceiveBd(swigCPtr, this, CkBinData.getCPtr(binData), binData);
  }

  public CkTask ReceiveBdAsync(CkBinData binData) {
    long cPtr = chilkatJNI.CkSocket_ReceiveBdAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean ReceiveBdN(long numBytes, CkBinData binData) {
    return chilkatJNI.CkSocket_ReceiveBdN(swigCPtr, this, numBytes, CkBinData.getCPtr(binData), binData);
  }

  public CkTask ReceiveBdNAsync(long numBytes, CkBinData binData) {
    long cPtr = chilkatJNI.CkSocket_ReceiveBdNAsync(swigCPtr, this, numBytes, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ReceiveSb(CkStringBuilder sb) {
    return chilkatJNI.CkSocket_ReceiveSb(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb);
  }

  public CkTask ReceiveSbAsync(CkStringBuilder sb) {
    long cPtr = chilkatJNI.CkSocket_ReceiveSbAsync(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ReceiveStringMaxN(int maxByteCount, CkString outStr) {
    return chilkatJNI.CkSocket_ReceiveStringMaxN(swigCPtr, this, maxByteCount, CkString.getCPtr(outStr), outStr);
  }

  public String receiveStringMaxN(int maxByteCount) {
    return chilkatJNI.CkSocket_receiveStringMaxN(swigCPtr, this, maxByteCount);
  }

  public CkTask ReceiveStringMaxNAsync(int maxByteCount) {
    long cPtr = chilkatJNI.CkSocket_ReceiveStringMaxNAsync(swigCPtr, this, maxByteCount);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean ReceiveStringUntilByte(int lookForByte, CkString outStr) {
    return chilkatJNI.CkSocket_ReceiveStringUntilByte(swigCPtr, this, lookForByte, CkString.getCPtr(outStr), outStr);
  }

  public String receiveStringUntilByte(int lookForByte) {
    return chilkatJNI.CkSocket_receiveStringUntilByte(swigCPtr, this, lookForByte);
  }

  public CkTask ReceiveStringUntilByteAsync(int lookForByte) {
    long cPtr = chilkatJNI.CkSocket_ReceiveStringUntilByteAsync(swigCPtr, this, lookForByte);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ReceiveUntilByte(int lookForByte, CkByteData outBytes) {
    return chilkatJNI.CkSocket_ReceiveUntilByte(swigCPtr, this, lookForByte, CkByteData.getCPtr(outBytes), outBytes);
  }

  public CkTask ReceiveUntilByteAsync(int lookForByte) {
    long cPtr = chilkatJNI.CkSocket_ReceiveUntilByteAsync(swigCPtr, this, lookForByte);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean SendBd(CkBinData binData, long offset, long numBytes) {
    return chilkatJNI.CkSocket_SendBd(swigCPtr, this, CkBinData.getCPtr(binData), binData, offset, numBytes);
  }

  public CkTask SendBdAsync(CkBinData binData, long offset, long numBytes) {
    long cPtr = chilkatJNI.CkSocket_SendBdAsync(swigCPtr, this, CkBinData.getCPtr(binData), binData, offset, numBytes);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean SendSb(CkStringBuilder sb) {
    return chilkatJNI.CkSocket_SendSb(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb);
  }

  public CkTask SendSbAsync(CkStringBuilder sb) {
    long cPtr = chilkatJNI.CkSocket_SendSbAsync(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean SendString(String stringToSend) {
    return chilkatJNI.CkSocket_SendString(swigCPtr, this, stringToSend);
  }

  public CkTask SendStringAsync(String stringToSend) {
    long cPtr = chilkatJNI.CkSocket_SendStringAsync(swigCPtr, this, stringToSend);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean SendWakeOnLan(String macAddress, int port, String ipBroadcastAddr) {
