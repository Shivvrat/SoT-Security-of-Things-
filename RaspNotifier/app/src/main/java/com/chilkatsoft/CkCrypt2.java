...
public class CkCrypt2 {
  ...
  public int get_BCryptWorkFactor() {
    return chilkatJNI.CkCrypt2_get_BCryptWorkFactor(swigCPtr, this);
  }

  public void put_BCryptWorkFactor(int newVal) {
    chilkatJNI.CkCrypt2_put_BCryptWorkFactor(swigCPtr, this, newVal);
  }
  ...
  public void get_OaepHash(CkString str) {
    chilkatJNI.CkCrypt2_get_OaepHash(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String oaepHash() {
    return chilkatJNI.CkCrypt2_oaepHash(swigCPtr, this);
  }

  public void put_OaepHash(String newVal) {
    chilkatJNI.CkCrypt2_put_OaepHash(swigCPtr, this, newVal);
  }

  public boolean get_OaepPadding() {
    return chilkatJNI.CkCrypt2_get_OaepPadding(swigCPtr, this);
  }

  public void put_OaepPadding(boolean newVal) {
    chilkatJNI.CkCrypt2_put_OaepPadding(swigCPtr, this, newVal);
  }
  ...
  public void get_SigningAlg(CkString str) {
    chilkatJNI.CkCrypt2_get_SigningAlg(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String signingAlg() {
    return chilkatJNI.CkCrypt2_signingAlg(swigCPtr, this);
  }

  public void put_SigningAlg(String newVal) {
    chilkatJNI.CkCrypt2_put_SigningAlg(swigCPtr, this, newVal);
  }
  ...
  public boolean AesKeyUnwrap(String kek, String wrappedKeyData, String encoding, CkString outStr) {
    return chilkatJNI.CkCrypt2_AesKeyUnwrap(swigCPtr, this, kek, wrappedKeyData, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String aesKeyUnwrap(String kek, String wrappedKeyData, String encoding) {
    return chilkatJNI.CkCrypt2_aesKeyUnwrap(swigCPtr, this, kek, wrappedKeyData, encoding);
  }

  public boolean AesKeyWrap(String kek, String keyData, String encoding, CkString outStr) {
    return chilkatJNI.CkCrypt2_AesKeyWrap(swigCPtr, this, kek, keyData, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String aesKeyWrap(String kek, String keyData, String encoding) {
    return chilkatJNI.CkCrypt2_aesKeyWrap(swigCPtr, this, kek, keyData, encoding);
  }

  public boolean BCryptHash(String password, CkString outStr) {
    return chilkatJNI.CkCrypt2_BCryptHash(swigCPtr, this, password, CkString.getCPtr(outStr), outStr);
  }

  public String bCryptHash(String password) {
    return chilkatJNI.CkCrypt2_bCryptHash(swigCPtr, this, password);
  }

  public boolean BCryptVerify(String password, String bcryptHash) {
    return chilkatJNI.CkCrypt2_BCryptVerify(swigCPtr, this, password, bcryptHash);
  }
  ...
  public boolean DecryptBd(CkBinData bd) {
    return chilkatJNI.CkCrypt2_DecryptBd(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean DecryptSb(CkBinData bdIn, CkStringBuilder sbOut) {
    return chilkatJNI.CkCrypt2_DecryptSb(swigCPtr, this, CkBinData.getCPtr(bdIn), bdIn, CkStringBuilder.getCPtr(sbOut), sbOut);
  }
  ...
  public boolean EncryptBd(CkBinData bd) {
    return chilkatJNI.CkCrypt2_EncryptBd(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean EncryptSb(CkStringBuilder sbIn, CkBinData bdOut) {
    return chilkatJNI.CkCrypt2_EncryptSb(swigCPtr, this, CkStringBuilder.getCPtr(sbIn), sbIn, CkBinData.getCPtr(bdOut), bdOut);
  }
  ...
  public boolean HashBdENC(CkBinData bd, CkString outStr) {
    return chilkatJNI.CkCrypt2_HashBdENC(swigCPtr, this, CkBinData.getCPtr(bd), bd, CkString.getCPtr(outStr), outStr);
  }

  public String hashBdENC(CkBinData bd) {
    return chilkatJNI.CkCrypt2_hashBdENC(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean HashFile(String path, CkByteData outBytes) {
    return chilkatJNI.CkCrypt2_HashFile(swigCPtr, this, path, CkByteData.getCPtr(outBytes), outBytes);
  }

  public CkTask HashFileAsync(String path) {
    long cPtr = chilkatJNI.CkCrypt2_HashFileAsync(swigCPtr, this, path);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean HashFileENC(String path, CkString outStr) {
    return chilkatJNI.CkCrypt2_HashFileENC(swigCPtr, this, path, CkString.getCPtr(outStr), outStr);
  }

  public String hashFileENC(String path) {
    return chilkatJNI.CkCrypt2_hashFileENC(swigCPtr, this, path);
  }

  public CkTask HashFileENCAsync(String path) {
    long cPtr = chilkatJNI.CkCrypt2_HashFileENCAsync(swigCPtr, this, path);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean MacBdENC(CkBinData bd, CkString outStr) {
    return chilkatJNI.CkCrypt2_MacBdENC(swigCPtr, this, CkBinData.getCPtr(bd), bd, CkString.getCPtr(outStr), outStr);
  }

  public String macBdENC(CkBinData bd) {
    return chilkatJNI.CkCrypt2_macBdENC(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean OpaqueSignBd(CkBinData bd) {
  ...
  public boolean OpaqueVerifyBd(CkBinData bd) {
    return chilkatJNI.CkCrypt2_OpaqueVerifyBd(swigCPtr, this, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean SignBdENC(CkBinData dataToSign, CkString outStr) {
    return chilkatJNI.CkCrypt2_SignBdENC(swigCPtr, this, CkBinData.getCPtr(dataToSign), dataToSign, CkString.getCPtr(outStr), outStr);
  }

  public String signBdENC(CkBinData dataToSign) {
  ...
  public String signSbENC(CkStringBuilder sb) {
  ...
  public boolean VerifyBdENC(CkBinData data, String encodedSig) {
    return chilkatJNI.CkCrypt2_VerifyBdENC(swigCPtr, this, CkBinData.getCPtr(data), data, encodedSig);
  }
  ...
  public boolean VerifySbENC(CkStringBuilder sb, String encodedSig) {
    return chilkatJNI.CkCrypt2_VerifySbENC(swigCPtr, this, CkStringBuilder.getCPtr(sb), sb, encodedSig);
  }
