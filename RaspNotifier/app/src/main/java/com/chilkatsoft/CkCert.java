...
public class CkCert {
  ...
  public boolean ExportCertDerBd(CkBinData cerData) {
    return chilkatJNI.CkCert_ExportCertDerBd(swigCPtr, this, CkBinData.getCPtr(cerData), cerData);
  }
  ...
  public boolean ExportToPfxBd(String password, boolean includeCertChain, CkBinData pfxData) {
    return chilkatJNI.CkCert_ExportToPfxBd(swigCPtr, this, password, includeCertChain, CkBinData.getCPtr(pfxData), pfxData);
  }
  ...
  public boolean LoadFromBd(CkBinData certBytes) {
    return chilkatJNI.CkCert_LoadFromBd(swigCPtr, this, CkBinData.getCPtr(certBytes), certBytes);
  }
  ...
  public boolean LoadPfxBd(CkBinData pfxData, String password) {
    return chilkatJNI.CkCert_LoadPfxBd(swigCPtr, this, CkBinData.getCPtr(pfxData), pfxData, password);
  }
